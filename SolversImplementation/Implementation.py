...
class Implementation_greedy_dc(AbstractImplementation):
    ...
    def solve(self, plan):
        ...
        vaktra = self.greedy_dc( lista_monthly_fees, lista_montantes_iniciais, monthly_available_list)
        if vaktra == -1:
...
#            print("\n")
    ...
    def greedy_dc(self, lista_monthly_fees, lista_montantes_iniciais, monthly_available_list):#returns list of payments
    ...
    #                break
          ...
          temp = self.greedy_dc( lista_monthly_fees, temp_montantes, temp_available)
...
class Implementation_greedy1(AbstractImplementation):
    ...
    def solve(self, plan):
        ...
        for key in debt_dic :
            ...
            lista_monthly_fees.append(debt_dic[key].get_monthly_fee())
            lista_montantes_iniciais.append(debt_dic[key].get_total_to_pay())
        vaktra = self.greedy1( lista_monthly_fees, lista_montantes_iniciais, monthly_available_list)
        if vaktra == -1:
            print("no solution found :(")
            return None
        ret_val = []
...
#            print("\n")
    ...
    def greedy1(self, lista_monthly_fees, lista_montantes_iniciais, monthly_available_list):
...
class Implementation_greedy2(AbstractImplementation):
    ...
    def solve(self, plan):
        ...
        for key in debt_dic :
            ...
            lista_monthly_fees.append(debt_dic[key].get_monthly_fee())
            lista_montantes_iniciais.append(debt_dic[key].get_total_to_pay())
        vaktra = self.greedy2( lista_monthly_fees, lista_montantes_iniciais, monthly_available_list)
        if vaktra == -1:
            print("no solution found :(")
            return None
        ret_val = []
...
#            print("\n")
    ...
    def greedy2(self, lista_monthly_fees, lista_montantes_iniciais, monthly_available_list):
       time=len(monthly_available_list)
       solution=[]
       lista_montantes=lista_montantes_iniciais.copy()
       for t in range(0,time):
...
class Implementation_greedy3(AbstractImplementation):
    ...
    def solve(self, plan):
        ...
        for key in debt_dic :
            ...
            lista_monthly_fees.append(debt_dic[key].get_monthly_fee())
            lista_montantes_iniciais.append(debt_dic[key].get_total_to_pay())
        vaktra = self.greedy3( lista_monthly_fees, lista_montantes_iniciais, monthly_available_list)
        if vaktra == -1:
            print("no solution found :(")
            return None
        ret_val = []
 ...
 #           print("\n")
    ...
    def greedy3(self, lista_monthly_fees, lista_montantes_iniciais, monthly_available_list):
       time=len(monthly_available_list)
       solution=[]
       lista_montantes=lista_montantes_iniciais.copy()
       for t in range(0,time):
